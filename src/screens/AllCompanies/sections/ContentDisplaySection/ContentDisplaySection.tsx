...
const tabOptions = [
  ...
  { value: "registered", label: "Registered Companies" },
  { value: "prequalified", label: "Prequalified Companies" },
];
          ...
          <div className="relative flex-1">
            <div className="relative">
              ...
              <div className="absolute right-3.5 top-1/2 transform -translate-y-1/2 flex items-center gap-2">
                ...
                <span className="[font-family:'Inter',Helvetica] font-medium text-[#101828] text-base">
                  SearchIcon
                </span>
              </div>
            </div>
                ...
                {companyData.map((company) => (
                  <React.Fragment key={company.id}>
                    <TableRow className="border-b-[1.11px] border-[#d2d6db]">
                      ...
                      <TableCell className="px-2.5 py-3.5">
                        <Badge className="bg-basic-white rounded-lg px-1.5 py-px relative overflow-hidden">
                          ...
                          <div className="flex flex-col gap-6 w-full">
                            <div className="flex items-center justify-between w-full">
                              ...
                              <img
                                className="w-6 h-6"
                                alt="Collapse"
                                src="/vuesax-outline-arrow-square-down-4.svg"
                              />
                            </div>
                            <img
