...
const companyData = [
  {
    id: 1,
    name: "Registered Corp A",
    type: "Single",
    rcNumber: "RC123456",
    email: "contact@regcorpa.com",
    status: "Registered",
    action: true,
    details: {
      rcNumber: "RC123456",
      ...
      website: "www.regcorpa.com",
    },
  },
  {
    id: 2,
    name: "Registered Corp B",
    type: "Joint Venture",
    rcNumber: "RC789012",
    email: "info@regcorpb.com",
    status: "Registered",
    action: true,
    details: {
      rcNumber: "RC789012",
...
const tabOptions = [
  ...
  { value: "inactive", label: "Inactive Companies" },
];
                ...
                {companyData.map((company) => (
                  <React.Fragment key={company.id}>
                    <TableRow className="border-b-[1.11px] border-[#d2d6db]">
                      ...
                      <TableCell className="px-2.5 py-3.5">
                        <Badge className="bg-blue-50 text-blue-700 rounded-lg px-1.5 py-px">
